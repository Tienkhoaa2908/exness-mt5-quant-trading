...
RUNNER="$SCRIPT_DIR/RUN_V48_DEMO_PAPER_START_HARDENED.py"
...
echo "=== V48 DEMO-PAPER FORWARD — HARDENED ATTACH ==="
echo "WORK=$WORK"
...
echo "Market may be closed: attach/OnInit/timer/dashboard gates must still pass."
...
echo "=== START PAPER OBSERVER — HARDENED ==="
"$PY" "$(cygpath -w "$RUNNER")"

echo
echo "V48 paper observer started and passed market-close-safe timer refresh."
echo "Keep MT5 open on the DEMO account and keep AutoTrading OFF."
