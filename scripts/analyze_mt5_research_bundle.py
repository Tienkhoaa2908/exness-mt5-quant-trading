...
def analyze(zip_path:Path):
 ...
 with zipfile.ZipFile(zip_path) as z:
  ...
  for ev in ("V46_EVIDENCE.txt","V45_EVIDENCE.txt","V44_EVIDENCE.txt","V42_EVIDENCE.txt","V41_EVIDENCE.txt","V40_EVIDENCE.txt","V39_EVIDENCE.txt"):
   if ev in names:result["evidence"]=parse_evidence(z.read(ev).decode("utf-8-sig"));break
  for kind,name in (("v46","v46_expert_breadth_analysis.json"),("v45","v45_multiyear_analysis.json"),("v44","v44_baseline_validation_analysis.json"),("v42","v42_baseline_router_analysis.json"),("v41","v41_baseline_stack_action_value_summary.json"),("v40","v40_upgrade_campaign_summary.json"),("v39","v39_selective_harvest_summary.json")):
