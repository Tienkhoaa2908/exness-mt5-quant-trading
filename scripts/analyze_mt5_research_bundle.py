...
def analyze(zip_path:Path):
 ...
 with zipfile.ZipFile(zip_path) as z:
  ...
  for ev in ("V41_EVIDENCE.txt","V40_EVIDENCE.txt","V39_EVIDENCE.txt"):
   if ev in names:result["evidence"]=parse_evidence(z.read(ev).decode("utf-8-sig"));break
  for kind,name in (("v41","v41_baseline_stack_action_value_summary.json"),("v40","v40_upgrade_campaign_summary.json"),("v39","v39_selective_harvest_summary.json")):
