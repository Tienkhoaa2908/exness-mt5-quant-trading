...
V44 was a historical robustness campaign. Current project-wide policy is governed by ADR-049:
- `LIVE_RESEARCH_ALLOWED=1`;
- `LIVE_DEPLOYMENT_TARGET=1`.

The V44 readiness label `PAPER_DEMO_READY` described what V44 evidence could support at that time. It is not a permanent ban on real-money research or later production/live deployment engineering.

## Goal

Stop adding overlays and validate the strongest baseline family broadly before deployment escalation.
...
Every independent window restarts from accepted state SHA `5110519f2fe9722b4c13eb1e5ceec42f00bd04dd3b4f071af28349068b6097b0`.

## Immutable source rule

V44 is built only from accepted V38 ZIP SHA `224296ae1c02792493c690e3be563dd278b2eab5a13a6cfaefd6e5eae052cf5b` and accepted V38 source SHA `4491d9d15233511d70735a5d8042eaaad1699df38fe2644d6419b08c7407ac12`.
...
A V44 PASS authorized progression to the next paper/demo validation phase in the historical workflow. Current production/live research policy is defined by ADR-049.

## Recovery

Use `docs/handover/WINDOWS_RUNTIME_FAILURE_PLAYBOOK.md`. Packaging/collection failures never justify rerunning completed MT5 evidence.
